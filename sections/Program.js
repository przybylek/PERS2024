...
const Program = () => (
    ...
    <Table bordered className="mt-5">
      <tbody>	
        ...
        <tr className='text-center table-primary'><th>Wednesday, August 28th</th><th>session chair: <em>Justyna Głogowska</em></th></tr>
        ...
        <tr><td className='text-nowrap'>16:45 - 17:00</td><td>Evaluating Diversity in Sequential Group Recommendations (<em>Haider Zulfiqar, Emilia Lenzi and Kostas Stefanidis</em>)</td></tr>        
